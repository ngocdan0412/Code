...
//		bang1.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
		setPanel(bang1);

		JPanel pnBG = new JPanel();
		pnBG.setBackground(null);
		pnBG.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
		...
		pnTN.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
		...
		pnNV.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
